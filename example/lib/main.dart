          ...
          child: Column(
            children: [
              ElevatedButton(
                //connect
                onPressed: () {
                  String walletURL = 'https://testnet.mynearwallet.com/login/?';
                  String contractId = 'friendbook.nearflutter.testnet';
            ...
            children: [
              ...
              ElevatedButton(
                ...
                onPressed: () async {
                  ...
                  AccessKey keys = await NEARTestNetRPCProvider().findAccessKey(connectedAccount.accountId, connectedAccount.publicKey);
                  var delegate = await NEARTestNetRPCProvider().buildDelegateAction(
                      [FunctionCallAction(actionNumber: ActionType.functionCall.value, functionCallActionArgs: FunctionCallActionArgs(
                        methodName: 'nft_buy',
                        args: '{"token_series_id":"1200","receiver_id":"unittest1.testnet"}',
                        gas: BigInt.from(1000000),
                        deposit: Utils.decodeNearDeposit('1')
                      ))],
                      BigInt.from(block) + BigInt.from(60),
                      BigInt.from(keys.nonce),
                ...
                child: const Text("Call view function 2"),
              )
            ],
          )),
    );
